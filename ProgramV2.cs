...
namespace nonograma
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int[,] rulesH = new int[,] { { 3,1,0}, { 1,1,1 }, { 2,2,0}, { 7,0,0 }, {1,4,1 }, { 2,2,1 }, { 3,4,0 }, {1,3,0 }, {2,2,1 }, { 4,3,0 } };
            int[,] rulesV = new int[,] { { 1,1,1,1}, { 3,2,0,0}, { 1,1,2,1 }, {1,1,2,0}, { 2,3,2,0 }, {5,1,0,0 }, { 3,1,1,0 }, { 2,4,0,0 }, { 1,3,1,0 }, {1,1,3,0 } };
            ...
            int[] get_empty(int [,] board)
            {
                ...
                if (con < 1000)
                {
                    while (true)
                    {
                        ...
                        int x = rnd.Next(board.GetLength(0));
                        int y = rnd.Next(board.GetLength(1));
                        if (board[x, y] == -1)
                        {
                            return new int[] { x, y };
                        }
